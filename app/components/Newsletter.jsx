  ...
  return (
    <div className="news">
      ...
      <p className="news__text">
        Inventore quia dolores consequatur aliquam est debitis vitae
        ducimus.Voluptatum maxime tenetur officiis cum est doloribus. Sapiente
        odio qui tempora ipsa non sed.
      </p>
      <form
